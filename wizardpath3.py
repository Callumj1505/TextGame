...
chest_buff = ["-- YOU HAVE RECIEVED A ROBE PEICE WITH +10 ARMORE! --", "-- YOU HAVE RECIEVED A NEW STAFF! +10 PHYSICAL DAMAGE! --", "-- YOU HAVE RECIEVED A NEW SPELLBOOK +10 MAGAICAL DAMAGE --"]
random.choice(chest_buff)
...
def goblin_killP3():
    ...
    if goblin <= 0:
        ...
        print(chest_buff)
        while True:
            if chest_buff == "-- YOU HAVE RECIEVED A ROBE PEICE WITH +10 ARMORE! --":
                poke -= 5
                body_slam -= 5
                Electric_Hammer -= 5
                Hammer_swing -= 5
                ...
                break
            elif chest_buff == "-- YOU HAVE RECIEVED A NEW STAFF! +10 PHYSICAL DAMAGE! --":
                wack += 5
                print("-- YOUR WACK ATTACK HAS GAINED +5 ATTACK")
                break
            elif chest_buff == "-- YOU HAVE RECIEVED A NEW SPELLBOOK +10 MAGAICAL DAMAGE --":
                fireball += 5
                zap += 5
                rolling_thunder += 5
                print ("-- FIREBALL, ZAP AND ROLLING THUNDER NOW HAVE +5 DAMAGE -- ")
        print (f'=============================================================================================')
        time.sleep(second3)
